...
namespace LoL_Forms
{
    public partial class ManageChampions : Form
    {
        ...
        private void fillFields(String selectedChampion)
        {
            ...
            query = "SELECT releaseDate, quote, splashArt, region_name, description, Gender, Species FROM Champion WHERE Name = @ChampionName";
        ...
        private void Save_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = DatabaseConnection.GetConnection())
            {
                using (SqlCommand command = new SqlCommand("dbo.AlterChampion", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
